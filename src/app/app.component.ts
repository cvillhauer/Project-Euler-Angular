...
export class AppComponent {
  ...
  constructor(){
    ...
    //PROBLEM 4
    let problem4 = new Problem(4, "A palindromic number reads the same both ways. The largest palindrome made from the product of two 2-digit numbers is 9009 = 91 × 99. Find the largest palindrome made from the product of two 3-digit numbers.");
    problem4.solveProblem = function(): void { 
      let n: number = 999; //Largest 3-digit number
      let i: number = n;
      let j: number = n;
      let result: number = 0;
      while(i % 11 != 0){
    ...
    //PROBLEM 5
    let problem5 = new Problem(5, "2520 is the smallest number that can be divided by each of the numbers from 1 to 10 without any remainder. What is the smallest positive number that is evenly divisible by all of the numbers from 1 to 20?");
